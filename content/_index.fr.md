...
Je m'appelle Antoine Soetewey. Je suis doctorant en statistique à l'UCLouvain (Belgique), passionné par l'analyse de données et l'utilisation du logiciel R (ainsi que ses multiples extensions) pour des applications pratiques.

En parallèle de mes recherches, je donne [cours](https://antoinesoetewey.com/fr/teaching/) de statistiques, probabilités et science des données à l'UCLouvain et UNamur. Je donne également des [cours particuliers](https://easystat.be/) et des formations à des étudiants et des chercheurs.
